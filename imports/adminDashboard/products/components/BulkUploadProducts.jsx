		    	...
		    	Meteor.call( 'BulkProductsCSVUpload', results.data, ( error, result ) => {
                	if ( error ) {
                        ...
                        swal({
                            position: 'top-right',
                            type: 'success',
                            title: 'Vehicle Data Added Successfully',
                            ...
                            <div className="col-md-12">
                                <div className="adminBlkUploadBtnDiv">
                                    <div className="input-group">
                                        ...
                                        <input onChange={this.uploadBulkVehicleData.bind(this)} className="adminBlkUpldBkg form-control adminBlkUploadBtn" type="file" name="" />
                                    </div>
                                </div>
                            </div>
